...
export function Practice() {
  return (
    <MotionTransition>
      <section id = "practice" className="grid items-center py-20 md:grid-cols-2 md:py-56">
        <div className="md:pr-20">
            ...
            <button className="bg-pink-400 text-white px-8 py-4 rounded-xl hover:bg-pink-500 transition-colors duration-400" >Empieza Ya</button>
        </div>
